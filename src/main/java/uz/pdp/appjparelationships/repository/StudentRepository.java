...
public interface StudentRepository extends JpaRepository<Student, Integer> {
    ...
    Boolean existsByAddressAndFirstNameAndLastName(Address address, String firstName, String lastName);

    Boolean existsByAddressAndFirstNameAndLastNameAndGroup(Address address, String firstName, String lastName, Group group);
